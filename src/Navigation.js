...
const navigation = [
    ...
    { name: 'Noticeboard', href: 'noticeboard', current: false },
];
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            {/* {navigation.map((item) => ( 
                                        <a
                                            key={item.name}
                                            href={item.href}
                                            onClick={() => setShowComponent(item.name)}
