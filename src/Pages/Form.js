...
function Forms() {
    return (
        <div className="custom-padding md:container md:mx-auto" >
            <form>
                            ...
                            <div className="sm:col-span-3">
                                ...
                                <div className="mt-2">
                                    <select
                                        ...
                                        className="block w-full rounded-md border-0 py-1.5 text-gray-900 mb-4 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm/6"
                                    >
